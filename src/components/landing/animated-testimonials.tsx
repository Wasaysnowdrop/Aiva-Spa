...
export function AnimatedTestimonials() {
  ...
  return (
    <div className="mt-14">
      ...
      <p className="mt-4 text-center text-xs text-[#5A626C]">
        Illustrative quotes shown for product context. Real customer
        testimonials will appear here once we have permission to publish them.
      </p>
    </div>
  );
}
